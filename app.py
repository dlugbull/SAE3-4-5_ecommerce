...
from controllers.client_gant import *
...
from controllers.admin_gant import *
from controllers.admin_declinaison_gant import *
from controllers.admin_commande import *
from controllers.admin_type_gant import *
...
app.register_blueprint(client_gant)
...
app.register_blueprint(admin_gant)
app.register_blueprint(admin_declinaison_gant)
app.register_blueprint(admin_commande)
app.register_blueprint(admin_type_gant)
